...
import { fetchOnAirSeries } from "../../../../Service/imdbAPI";
import Aos from "aos";
...
const page = ({ content }) => {
    ...
    useEffect(() => {
        const getOnAirSeries = async () => {
            try {
                const res = await fetchOnAirSeries();
                setMovie(res);
            } catch (err) {
                console.log("getOnAirSeries error: ", err);
            }
        };
    ...
    return (
        <div className="relative">
            ...
            <div className="my-5 ml-8 flex items-center">
                ...
                <h1 className="text-xl font-semibold">Now On air</h1>
