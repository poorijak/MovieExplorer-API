...
import { fetchNowplayMovie } from "../../../../Service/imdbAPI";
import Aos from "aos";
...
const page = ({ content }) => {
    ...
    useEffect(() => {
        const getNowplayMovie = async () => {
            try {
                const res = await fetchNowplayMovie(content);
                setMovie(res);
            } catch (err) {
                console.log("getTopRated error: ", err);
            }
        };
    ...
    return (
        <div className="relative">
            ...
            <div className="my-5 ml-8 flex items-center">
                ...
                <h1 className="text-xl font-semibold">Now Playing {content}</h1>
