...
export function TextAnimate({
        ...
        container: {
          ...
          show: {
            ...
            transition: {
              ...
              delayChildren: delay, // ✅ เพิ่ม delayChildren เพื่อหน่วงเวลาเริ่มแอนิเมชัน
            },
          },
          exit: {
  ...
  switch (by) {
    case "word":
      segments = typeof children === "string" ? children.split(/(\s+)/) : [];
      break;
    case "character":
      segments = typeof children === "string" ? children.split("") : [];
      break;
    case "line":
      segments = typeof children === "string" ? children.split("\n") : [];
      break;
